...
/**
 * ComputeMultCPStressCpl (used together with CrystalPlasticityStressUpdateBase)
 ...
 */
class ComputeMultCPStressCpl : public ComputeFiniteStrainElasticStress
{
public:
  static InputParameters validParams();

  ComputeMultCPStressCpl(const InputParameters & parameters);
