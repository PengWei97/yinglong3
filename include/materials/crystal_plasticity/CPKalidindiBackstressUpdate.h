...
class CPKalidindiBackstressUpdate;

class CPKalidindiBackstressUpdate : public CrystalPlasticityKalidindiUpdate
{
public:
  static InputParameters validParams();

  CPKalidindiBackstressUpdate(const InputParameters & parameters);
